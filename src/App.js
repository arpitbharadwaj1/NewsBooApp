  ...
  render() {
    return (
      ...
      />
          <NavBar />
          <Routes>
            <Route path='/' exact element={<News setProgress={this.setProgress} apiKey={this.apiKey}  key='general' pageSize={this.pageSize} country='in' category="general"></News>}></Route>
